...
public final class AssetManager implements AutoCloseable {
    ...
    private static final String NG_APK_PATH = "/system/framework/org.eu.droid_ng.platform-res.apk";
    ...
    public static void createSystemAssetsInZygoteLocked(boolean reinitialize,
        ...
        try {
            ...
            apkAssets.add(ApkAssets.loadFromPath(NG_APK_PATH, ApkAssets.PROPERTY_SYSTEM));
