...
public class NavBarEditor extends PreferenceFragment implements TunerService.Tunable {
    ...
    public void onTuningChanged(String key, String navLayout) {
        ...
        String[] groups = new String[] { NavBarAdapter.START, NavBarAdapter.CENTER,
                NavBarAdapter.END};
        CharSequence[] groupLabels = new String[] { getString(org.eu.droid_ng.platform.internal.R.string.start),
                getString(org.eu.droid_ng.platform.internal.R.string.center), getString(org.eu.droid_ng.platform.internal.R.string.end) };
        ...
        mNavBarAdapter.addButton(NavBarAdapter.ADD, getString(org.eu.droid_ng.platform.internal.R.string.add_button));
    }
    ...
    private static CharSequence getLabel(String button, Context context) {
        if (button.startsWith(HOME)) {
            ...
            return context.getString(org.eu.droid_ng.platform.internal.R.string.space);
        } else if (button.startsWith(LEFT)) {
            return context.getString(org.eu.droid_ng.platform.internal.R.string.left);
        } else if (button.startsWith(RIGHT)) {
            return context.getString(org.eu.droid_ng.platform.internal.R.string.right);
        } else if (button.startsWith(POWER)) {
            return context.getString(org.eu.droid_ng.platform.internal.R.string.navbar_editor_power);
        } else if (button.startsWith(VOLUME_UP)) {
            return context.getString(org.eu.droid_ng.platform.internal.R.string.navbar_editor_volup);
        } else if (button.startsWith(VOLUME_DOWN)) {
            return context.getString(org.eu.droid_ng.platform.internal.R.string.navbar_editor_voldown);
        /*} else if (button.equals(MENU_IME_ROTATE)) {
            return context.getString(org.eu.droid_ng.platform.internal.R.string.menu_ime);*/
        /*} else if (button.startsWith(CLIPBOARD)) {
            return context.getString(org.eu.droid_ng.platform.internal.R.string.clipboard);*/
        /*} else if (button.startsWith(KEY)) {
            return context.getString(org.eu.droid_ng.platform.internal.R.string.keycode);*/
        }
        return button;
    }
    ...
    private class NavBarAdapter extends RecyclerView.Adapter<Holder>
        ...
        private void showAddDialog(final Context context) {
            ...
            new AlertDialog.Builder(context)
                    .setTitle(org.eu.droid_ng.platform.internal.R.string.select_button)
        ...
        /*private void showKeyDialogs(final Context context) {
            ...
            new AlertDialog.Builder(context)
                    .setTitle(org.eu.droid_ng.platform.internal.R.string.keycode)
                    .setMessage(org.eu.droid_ng.platform.internal.R.string.keycode_description)
        ...
        /*private void showAddedMessage(Context context, String button) {
            if (CLIPBOARD.equals(button)) {
                new AlertDialog.Builder(context)
                        .setTitle(org.eu.droid_ng.platform.internal.R.string.clipboard)
                        .setMessage(org.eu.droid_ng.platform.internal.R.string.clipboard_description)
        ...
        private void showWidthDialog(final Holder holder, Context context) {
            ...
            final AlertDialog dialog = new AlertDialog.Builder(context)
                    .setTitle(org.eu.droid_ng.platform.internal.R.string.adjust_button_width)
