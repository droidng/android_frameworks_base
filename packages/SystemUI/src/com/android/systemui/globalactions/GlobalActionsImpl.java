...
public class GlobalActionsImpl implements GlobalActions, CommandQueue.Callbacks {
    ...
    public void showGlobalActions(GlobalActionsManager manager) {
        if (mDisabled) return;
        fullDialog = org.eu.droid_ng.providers.NgSettings.Secure.getInt(mContext.getContentResolver(), org.eu.droid_ng.providers.NgSettings.Secure.POWER_MENU_TYPE, 0) == 1;
